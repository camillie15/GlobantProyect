...
public class BuyToExchangeController {
    ...
    /**
     *This method executes a series of processes, such as requesting data from the user for the type and amount
     * of crypto to buy and then calling a method that processes the buy request.
     */
    public void execute(){
